    ...
    if (searchTerm.trim()) {
      ...
      sorted = sorted.filter(
        t =>
          ...
          (t.positionRole &&
            t.positionRole.toLowerCase().includes(lowerQuery)) ||
          (t.group && t.group.toLowerCase().includes(lowerQuery))
      );
    }

    return sorted;
  }, [templates, selectedGroup, coreStakeholders, searchTerm]);
      ...
      <div className="relative w-full max-w-4xl mx-auto my-6">
        <div className="relative flex flex-col w-full bg-white border-0 rounded-lg shadow-lg outline-none focus:outline-none dark:bg-gray-800">
          ...
          <div className="relative flex-auto p-0 flex max-h-[70vh] min-h-[50vh]">
            {/* Sidebar */}
            <div className="w-1/3 border-r border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50 overflow-y-auto flex flex-col">
